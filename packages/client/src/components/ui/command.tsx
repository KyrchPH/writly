...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      <DialogHeader className={styles.command__dialogHeader}>
        <DialogTitle>{title}</DialogTitle>
        <DialogDescription>{description}</DialogDescription>
      </DialogHeader>
      <DialogContent className={styles.command__dialogContent}>
        <Command>
          {children}
        </Command>
      </DialogContent>
...
function CommandInput({
  ...
  return (
    <div
      ...
      className={styles.command__inputWrapper}
    >
      <SearchIcon className={styles.command__inputIcon} />
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(styles.command__shortcut, className)}
      {...props}
    />
  );
}
